...
OBJECTS = ¶
		:objects:softreset.c.o ¶
		:objects:serialdebug.c.o
...
BOOTDIR	= "{VECTORDIR}"
### CASE 2.0:
#MODULEDIR	= Data:3DO_OS:M2_3.1:Remote:System.m2:Modules:
#BOOTDIR	= Data:3DO_OS:M2_3.1:Remote:System.m2:Boot:
### } END SWITCH
...
{appname}ÄÄ DELETE_LEFTOVERS
DELETE_LEFTOVERS Ä
	Set Echo 0
	if "`files "{TempFolder}"`" != ""
		Echo "#----Deleting leftover temp files from ¶"{TempFolder}¶""
		delete -i -c "{TempFolder}"Å· dev:null
	end if
	Set Echo 1
